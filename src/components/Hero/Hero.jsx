  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-[#f8f8fb]">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-10 lg:py-16">
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            <div>
              ...
              <h1 className="max-w-[650px] text-[42px] font-black leading-[1.02] tracking-[-0.05em] text-[#0b132b] sm:text-[56px] lg:text-[72px]">
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-10">
          ...
          <div className="mb-14 flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-end">
            ...
            <div>
              <p className="mb-4 text-[12px] font-bold uppercase tracking-[0.28em] text-[#8266ff]">
                WHO WE ARE
              </p>

              <h2 className="max-w-[700px] text-[34px] font-black leading-[1.1] tracking-[-0.04em] text-[#0b132b] sm:text-[48px]">
                Building scalable digital environments for modern businesses.
              </h2>
            </div>

            <Link
              to="/about"
              className="rounded-2xl border border-[#d9dce5] px-7 py-4 text-sm font-bold text-[#111827] transition duration-300 hover:border-[#8266ff] hover:text-[#8266ff]"
            >
              Read More
            </Link>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <div className="rounded-[28px] border border-[#edf0f5] bg-[#f8f8fb] p-8">
              <h3 className="text-[20px] font-black text-[#0b132b]">
                Smart Operations
              </h3>

              <p className="mt-4 text-[15px] leading-[1.9] text-[#6b7280]">
                We help businesses streamline workflows and improve operational visibility.
              </p>
            </div>
            ...
            <div className="rounded-[28px] border border-[#edf0f5] bg-[#f8f8fb] p-8">
              ...
              <p className="mt-4 text-[15px] leading-[1.9] text-[#6b7280]">
                Our systems are designed based on practical field experience and real workflows.
              </p>
            </div>
            ...
            <div className="rounded-[28px] border border-[#edf0f5] bg-[#f8f8fb] p-8">
              ...
              <p className="mt-4 text-[15px] leading-[1.9] text-[#6b7280]">
                We build scalable digital foundations that support long-term business growth.
              </p>
            </div>
